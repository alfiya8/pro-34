...
var food;
var rabbit;
var star1,star2,starImg1,starImg2;
var emptyStars,oneStar,twoStars;
var starDisplay;
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   airBlowerbtn = createImg('baloon2.png');
   airBlowerbtn.position(260,370);
   airBlowerbtn.size(80,120);
   airBlowerbtn.mouseClicked(airBlow);
  ...
  starDisplay.addAnimation("empty",emptyStars);
  starDisplay.addAnimation("one",oneStar);
  starDisplay.addAnimation("two",twoStars);
